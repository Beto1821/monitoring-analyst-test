...
# Load CSV file
df = pd.read_csv("data/checkout_1.csv")
df = pd.read_csv("data/checkout_2.csv")
...
show_today = st.checkbox("Show Today Sales", value=True)
show_yesterday = st.checkbox("Show Yesterday Sales", value=True)
show_same_day_last_week = st.checkbox(
    "Show Same Day Last Week Sales", value=True
    )
